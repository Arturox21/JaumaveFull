...
class Taza extends StatelessWidget {
  const Taza({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text(
            'Taza de recuerdo 3D'.toUpperCase(),
        ...
        body: ModelViewer(
          src:
              'https://raw.githubusercontent.com/Arturox21/Model3DJaumave/main/taza.glb',
          ar: true,
