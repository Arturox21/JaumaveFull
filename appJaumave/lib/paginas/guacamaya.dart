...
class Guacamaya extends StatelessWidget {
  const Guacamaya({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ModelViewer(
          src:
              'https://raw.githubusercontent.com/Arturox21/Model3DJaumave/main/guacamaya.glb',
          ar: true,
